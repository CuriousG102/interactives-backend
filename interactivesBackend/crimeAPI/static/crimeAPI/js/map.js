        ...
        var drawOverlay = function() {
            d3.json(AREAS_JSON_URL, function(error, areas_map) {
                ...
                missionControl.slider.data('daterangepicker')
                    .setStartDate(moment().subtract(missionControl.DAYS_FROM_PRESENT + missionControl.DAYS_IN_PAST_FOR_DEFAULT, 'days'));

                missionControl.slider.data('daterangepicker')
                    .setEndDate(moment().subtract(missionControl.DAYS_FROM_PRESENT, 'days'));
